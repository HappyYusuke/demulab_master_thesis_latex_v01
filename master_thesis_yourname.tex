...
\def\KITMODE{thesis} % ← ar にしたければ thesis を ar に変える
...
% ----- 修論用 -----
\kittitle{Development of a Human Following System Using 3D LiDAR and ReID3D}
\kitauthor{Yusuke Kanazawa}
%\kitstudentid{6400686}
...
\thesisonly{%
    \publicationspage{%
    \begin{enumerate}
       \item Y Kanazawa, K Demura. Development of a Human Tracking System Using 2D LiDAR and YOLOv10 (2D LiDAR と YOLOv10 を用いた人追従システムの開発). The 42nd Annual Conference of the Robotics Society of Japan (日本ロボット学会学術講演会). 2024;42:1D4-06. (in Japanese).
       \item Y Kanazawa, K Demura. Development of a Human Following System Using 3D LiDAR and ReID3D (3D LiDAR と ReID3D を用いた人追従システムの開発). The 43nd Annual Conference of the Robotics Society of Japan (日本ロボット学会学術講演会). 2025;43:1I5-04. (in Japanese).
    \end{enumerate}
    }
}
